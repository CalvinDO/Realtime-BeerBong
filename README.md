...
Realtime BeerPong ist eine AR-Anwendung die das Spiel Beer Pong mittel AFrame und JavaScript darstellt. Die Anwendung wurde im Rahmen der Veranstaltung Echtzeit Computergrafik der Hochschule Furtwangen im Sommersemester 2022 durchgeführt. Der Kurs wurde geleitet von Prof. Dr. Uwe Hahne.

## Ausführung des Codes
Zur Ausführung des Codes empfehlen wir folgende Vorgehensweise mit Microsoft (falls Sie ein anderes Betriebssystem verwenden kann die Vorgehensweise abweichen):
...
6. Lassen Sie sich den Marker (welchen Sie unter Assets mit dem Namen BeerPongMarker.pdf finden können) entweder auf Ihrem Laptop anzeigen oder drucken Sie diesen aus. Wenn Sie mit ihrer Smartphone Kamera in der Anwendung den Marker scannen sollte die AR-Szene von Realtime BeerPong erscheinen.  
...
**Die Anwendung hatte auf Android in Google Chrome die stabilste Ausführung. In Mozilla war Sie auch ausführbar jedoch gab es hier keine weitläufigen Tests.**